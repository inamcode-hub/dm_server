...
const { sendMessageToDevice, sendMessageToAllDevices } = require('../routes/devices/websocketRoute');
...
//set time interval to generate token every 30 seconds

// setInterval(() => {
//     sendMessageToDevice('ID-3636', 'Hello, device!');


// }, 3000); // 30 seconds

// setInterval(() => {
//     sendMessageToAllDevices('All devices', 'Hello, all devices!');
